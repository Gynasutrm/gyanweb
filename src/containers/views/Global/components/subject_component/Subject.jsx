...
const Subject = () => {
	...
	const addStream = () => {
		if (stream == '' && stream.length == 0) {
			setErrMsg('Please enter to Add Subject.');
			setTimeout(() => {
				setErrMsg('');
			}, 1500);
			return false;
	...
	const editStream = () => {
		if (updateStrm == '' && updateStrm.length == 0) {
			setErrMsg('Please enter to Update Subject.');
			setTimeout(() => {
				setErrMsg('');
			}, 1500);
			return false;
										...
										<li key={v}>
											...
											<span>
												<a
													...
													onClick={() =>
														updateStream(txt.subject_id, txt.subject_name)
													}
													href="javascript:void(0);"
												>
													Edit
												...
												<a
													...
													href="javascript:void(0);"
													onClick={() => removeStream(txt.subject_id)}
												>
													Delete
												</a>
											</span>
