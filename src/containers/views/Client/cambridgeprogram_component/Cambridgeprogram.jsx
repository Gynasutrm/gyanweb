...
import './Cambridgeprogram.css';
const images_path = process.env.PUBLIC_URL + '/assets/images/';
const Cambridgeprogram = () => {
  return (
    <section className="row_full" style={{paddingBottom:'30px'}}>
      ...
      <div className="row_full pageBanner" style={{background:`url(${images_path}aboutus.jpg)`}}>
        ...
        <div className="overLay">
            <h2 className="pageName">Cambridge program</h2>
        </div>
      </div>
        ...
        <div className="row">
            <div className="col col-sm-12 col-md-12 col-lg-12">
                <div className="row_full aboutContent">
                    ...
                    <h3 className="spartner_title font_w_semi-bold">Cambridge program</h3>
