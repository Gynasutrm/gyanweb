...
const Dashboard = () => {
	...
	useEffect(() => {
		if (state && state.userInfo) {
			...
			if (state.userInfo?.profile_completed === '50%') {
				history.push({
					pathname: `/studentpathshala/myprofile`,
				});
			}
		}
	}, []);
	const openCourseDetails = (e, type) => {
		history.push({
			pathname: `/studentpathshala/${type}`,
		});
	};
	return (
		<div className="student-pathshala-content">
			<div className="row">
						...
						<div className="row">
							<div className="col-lg-2 col-md-6 col-sm-6 col-xs-12">
								<div className="card h-100 text-white bg-blue">
									<div className="card-body course">
										<p className="f-s-2 text-white">
											{state.userInfo?.active_course[0]
												? state.userInfo?.active_course[0]?.course_name
												: 'No Course'}
										</p>
									</div>
								</div>
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 pl-0">
								<div className="card text-white bg-green h-100">
									<div className="card-body best-subject">
										<div className="card-text">
											<p className="w-100 d-flex">
												...
												>
													...
													>
														{state.userInfo?.performance?.best_subject}
													</button>
												</span>
											</p>
											...
											<p className="w-100 mt-2 d-flex">
												...
												>
													<button
														className={'btn btn-sm bg-light-green w-100 f-s-12'}
													>
														{state.userInfo?.performance?.best_topic}
													</button>
												</span>
											</p>
										</div>
							...
							<div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 pl-0">
								<div className="card text-white bg-pink h-100">
									<div className="card-body worst-subject">
										<p className="w-100 d-flex">
											...
											<span className={'w-50 float-end d-inline-block'}>
												...
												>
													{state.userInfo?.performance?.poor_subject}
												</button>
											</span>
										</p>
										...
										<p className="w-100 mt-2 d-flex">
											...
											>
												...
												>
													{state.userInfo?.performance?.poor_topic}
												</button>
											</span>
										</p>
									</div>
									...
									<div className="card-body profile-info">
										<div className="text-white f-s-2 pro-comp">
											<span className={'w-50 text-left d-inline-block'}>
												Hi {state.userInfo?.profile_data.full_name}
											</span>
											<span
										...
										<div className="text-white mt-2 f-s-2">
												...
												>
													<div className="w-100 d-block f-s-12">
														...
														<span className={'d-inline-block ml-2'}>
															{state.userInfo?.profile_data.full_name}
														</span>
													</div>
													<div className="w-100 mt-1 d-block f-s-12">
														...
														:
														<span className={'d-inline-block ml-2'}>
															{state.userInfo?.profile_data.enrollment_id}
														</span>
													</div>
												</div>
											</div>
											<div className={'w-40 text-left d-inline-block'}>
												<div className={'w-100 d-flex item-center'}>
													...
													<span className={'f-s-12 ml-1'}>
														{state.userInfo?.profile_completed}
													</span>
												</div>
												<Link
													className="badge bg-white com-pro text-info f-s-12"
													to="/studentpathshala/myprofile"
												>
													<span className="menu-title">Complete Profile</span>
												</Link>
											</div>
										</div>
									</div>
				...
				<div className="col-lg-3 col-md-6 col-sm-12">
					<div className="card text-center">
						<div className="card-body">
							...
							<button
								type="button"
								onClick={(e) => openCourseDetails(e, 'igl')}
								className="btn btn-sm mt-2 btn-border-info"
							>
								Details
							</button>
						</div>
				...
				<div className="col-lg-3 col-md-6 col-sm-12">
					<div className="card text-center">
						<div className="card-body">
							...
							<button
								type="button"
								onClick={(e) => openCourseDetails(e, 'jigyasha')}
								className="btn btn-sm mt-2 btn-border-info"
							>
								Details
							</button>
				...
				<div className="col-lg-3 col-md-6 col-sm-12">
					<div className="card text-center">
						<div className="card-body">
							...
							<button
								type="button"
								onClick={(e) => openCourseDetails(e, 'gsamadhan')}
								className="btn btn-sm mt-2 btn-border-info"
							>
								Details
							</button>
				...
				<div className="col-lg-3 col-md-6 col-sm-12">
					<div className="card text-center">
						<div className="card-body">
							...
							<button
								type="button"
								onClick={(e) => openCourseDetails(e, 'garchive')}
								className="btn btn-sm mt-2 btn-border-info"
							>
								Details
							</button>
